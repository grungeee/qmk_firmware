 ...
 * >====> Lower + Raise = Adjust <====< 
    [_QWERTY] = LAYOUT(
      OS_GUI,      KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,                                                           KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
      OS_ALT,      KC_A,   KC_S,   KC_D,   KC_F,   KC_G,                                                           KC_H,    KC_J,    KC_K,    KC_L,    TD(CT_SCLN), KC_QUOT,
      ALT_TAB,      KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   _______,  KC_CAPS,                       KC_NUM, _______,  KC_N,   KC_M,    TD(CT_COMM), TD(CT_DOT),  KC_SLSH, KC_ESC,
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
     _______, KC_Y,   KC_C,     KC_L,     KC_M,    KC_K,    												KC_Z,   KC_F,   KC_U,   TD(DANCE_2),  KC_BSPC,	_______,
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
     _______, KC_I,   KC_S,  MT(MOD_LALT,KC_R),    MT(MOD_LGUI,KC_T),    KC_G,				KC_P,   MT(MOD_RGUI,KC_N), MT(MOD_RALT,KC_E),  KC_A,  KC_O, _______,
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
     _______, KC_Q,   KC_V,  KC_W,   KC_D,  KC_J,    _______, _______,                        _______, _______,	KC_B,  KC_H, TD(DANCE_3),  TD(DANCE_1), KC_X, _______,
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
	 _______, _______, _______,                 MT(MOD_MEH,KC_SPACE), OSM(MOD_LSFT),         OSM(MOD_RCTL), TO(1),                               _______, _______, _______
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
  ),
  ...
  //----------------------------------------------------------------------------       ----------------------------------------------------------------------------------
   _______, KC_TILD, TD(DANCE_33), LALT(KC_LBRACKET), LALT(LSFT(KC_LBRACKET)), KC_DQUO, _______, _______,    _______, _______, KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC, TO(3), _______,
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
		    _______, _______, _______,		TO(0), OSM(MOD_LSFT),                            KC_RALT, TO(2), _______, _______, _______
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
  ...
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
  _______, KC_ESCAPE,      KC_MEDIA_PLAY_PAUSE,KC_MEDIA_PREV_TRACK,KC_MEDIA_NEXT_TRACK,LSFT(KC_MINS),KC_MINS,   KC_7,  KC_8, KC_9,KC_TRANSPARENT, _______,
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
  _______,  KC_TAB,  KC_TRANSPARENT, KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,LSFT(KC_EQL),   KC_EQL,   KC_4, KC_5, KC_6,   KC_ENTER, _______,
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
  _______,  RESET,   KC_KP_ASTERISK, KC_BRIGHTNESS_DOWN,KC_BRIGHTNESS_UP,KC_KP_DOT,  _______, _______,    _______, _______, KC_0, KC_1, KC_2, KC_3, KC_TRANSPARENT, _______,
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
	  _______,_______,_______,TO(0), KC_LGUI,                                                                   KC_RALT, TO(2), _______, _______, _______
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
  ),

  [3] = LAYOUT(
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
   _______, TD(DANCE_54), KC_MS_WH_LEFT, KC_MS_UP, KC_MS_WH_RIGHT, TD(DANCE_55),  LGUI(KC_LBRACKET), LCTL(LSFT(KC_TAB)), RCTL(KC_TAB), LGUI(KC_RBRACKET),KC_TRANSPARENT, _______,
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
  ...
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
     _______,TD(DANCE_58), KC_MS_BTN2, KC_MS_WH_UP, KC_MS_WH_DOWN, KC_TRANSPARENT, _______, _______,    _______, _______, KC_MS_BTN1, KC_MS_ACCEL0, KC_MS_ACCEL1, KC_MS_ACCEL2, KC_NO, _______,
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
                        _______, _______, _______, TO(0), KC_TRANSPARENT,                    KC_RALT, TO(1), _______, _______, _______
  //------------------------------------------------------------------------------       -------------------------------------------------------------------------------
  )
};
